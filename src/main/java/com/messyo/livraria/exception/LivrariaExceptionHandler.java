package com.messyo.livraria.exception;
...
public class LivrariaExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleEntityNotFoundException(EntityNotFoundException e) {
        return buildResponseEntity(HttpStatus.NOT_FOUND, e.getMessage(), Collections.singletonList(e.getMessage()));
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        ex.getBindingResult().getGlobalErrors()
                .forEach(globalError -> errors
                        .add("Field " + globalError.getObjectName() + " " + globalError.getDefaultMessage()));
